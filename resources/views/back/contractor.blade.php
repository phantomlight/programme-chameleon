...
@section('title')
Contractor | Programme Chameleon
@stop
				...
				<div class="col-lg-12">
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content">
							<div class="row">
								<div class="col-sm-12">
									<table data-route="{{ route('admin.contractor.list') }}" data-user-link="{{ route('admin.contractor.ban') }}" class="footable footable-init toggle-arrow-tiny table table-stripped" data-page-size="10" data-paging="true" id="tableList">
										<thead>
											<tr>
												...
												<th data-id="last_login" data-sort="3" data-hide="all" data-sort-ignore="true">
													Last Login
												</th>
