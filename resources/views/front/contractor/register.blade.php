					...
					<div id="register-form-wrapper" class="element-bottom-30">
						<form role="form" id="register-form" onsubmit="return false;" data-parsley-validate data-route="{{ route('contractor.postRegister') }}">
							...
							<div class="form-group no-border">
								<label for="terms">
									<input type="checkbox" required id="terms" name="terms"> I agree to the <a href="#" data-toggle="modal" data-target="#terms-modal">terms &amp; conditions</a> to be a contractor/job seeker on this site.
								</label>
							</div>
