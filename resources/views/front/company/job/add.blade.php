	...
	<div class="common-page-wrapper">
		<div class="container">
			<div class="row element-top-30 element-bottom-10">
				<div class="col-sm-8">
					<form class="sc-form clearfix" id="companyPostJobForm" role="form" onsubmit="return false;">
						<div class="form-section">
							...
							@if ( ! $company->is_vip)
								<div class="form-group">
									...
									<span class="help-block">You currently have: {{ $company->credit }} credit(s).</span>
								</div>
							@endif
