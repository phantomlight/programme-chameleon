	...
	<div class="common-page-wrapper">
		<div class="container">
			<div class="row element-top-30 element-bottom-10">
				<div class="col-sm-8">
					<form class="sc-form clearfix" id="companyEditJobForm" role="form" onsubmit="return false;" data-job="{{ $job->id }}">
						<div class="form-section">
							...
							<div class="form-group">
								...
								<span class="help-block">If you have add the duration, you have to use credit again. You currently have: {{ $company->credit }} credit(s).</span>
							</div>
							@endif
