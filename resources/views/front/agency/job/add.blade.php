	...
	<div class="common-page-wrapper">
		<div class="container">
			<div class="row element-top-30 element-bottom-10">
				<div class="col-sm-8">
					<form class="sc-form clearfix" id="agencyPostJobForm" role="form" onsubmit="return false;">
						<div class="form-section">
							<div class="form-group">
								...
								<select name="company" class="form-control">
									@foreach ($companies as $company)
										<option value="{{ $_hash->encode($company->id) }}">{{ $company->name }}</option>
									@endforeach
								</select>
								@else
							...
							@if ( ! $agency->is_vip)
								<div class="form-group">
									...
									<span class="help-block">You currently have: {{ $agency->credit }} credit(s).</span>
								</div>
							@endif
